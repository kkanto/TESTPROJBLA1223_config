...
def job_config = [
    job: [
        name: "TESTPROJBLA1223_Feature_Build",
        agent: "maven"
    ]
]
def config = [
    ...
    stage('Prepare') {
      steps {
        ...
        script {
          ...
          jslGit.checkout( config, "kkanto", "TESTPROJBLA1223", branch_name)
          }
        }
      }
stage('Build') {
...
"""
def job = pipelineJob("TESTPROJBLA1223_Feature_Build");
